...
var sprites = [
    new Sprite('Bilgewater', 5, 'Bilgewater', 'img/sprites/5.png', 'Region'),
    new Sprite('Demacia', 0, 'Demacia', 'img/sprites/0.png', 'Region'),
    new Sprite('Freljord', 18, 'Freljord', 'img/sprites/18.png', 'Region'),
    new Sprite('Ionia', 11, 'Ionia', 'img/sprites/11.png', 'Region'),
    new Sprite('Noxus', 1, 'Noxus', 'img/sprites/1.png', 'Region'),
    new Sprite('Piltover', 19, '', 'img/sprites/19.png', 'Region'),
    new Sprite('Shadow isles', 12, 'Shadowisles', 'img/sprites/12.png', 'Region'),
    new Sprite('All regions', 17, '', 'img/sprites/17.png', 'Region'),
    new Sprite('Targon', 6, '', 'img/sprites/6.png', 'Region'),
