...
var sprites = [
    ...
    new Sprite('Ionia', 13, 'Ionia', 'img/sprites/Ionia.png', 'Region'),
    ...
    new Sprite('All regions', 12, 'AllFactions', 'img/sprites/AllFactions.png', 'Region'),
    new Sprite('Targon', '', 'Targon', 'img/sprites/Targon.png', 'Region'),
    ...
    new Sprite('Level up: empty', 14, 'ChampLevelUpIcon1', 'img/sprites/ChampLevelUpIcon1.png', 'Levelup'),
    ...
    new Sprite('Common wildcard', 16, 'common', 'img/sprites/common.png', 'Wildcard'),
    new Sprite('Rare wildcard', 17, 'rare', 'img/sprites/rare.png', 'Wildcard'),
    new Sprite('Epic wildcard', 18, 'epic', 'img/sprites/epic.png', 'Wildcard'),
    new Sprite('Champion wildcard', 19, 'champion', 'img/sprites/champion.png', 'Wildcard'),
    new Sprite('Shards', 3, 'currency_shards', 'img/sprites/currency_shards.png', 'Currency'),
    new Sprite('Coin', 7, 'currency_bp', 'img/sprites/currency_bp.png', 'Currency'),
    new Sprite('Burst', 2, 'Burst', 'img/sprites/Burst.png', 'SpellSpeed'),
    new Sprite('Fast', 15, 'Fast', 'img/sprites/Fast.png', 'SpellSpeed'),
    new Sprite('Slow', 11, 'Slow', 'img/sprites/Slow.png', 'SpellSpeed'),
