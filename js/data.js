...
var sprites = [
    new Sprite('Bilgewater', 8, 'Bilgewater', 'img/sprites/5.png', 'Region'),
    new Sprite('Demacia', 4, 'Demacia', 'img/sprites/0.png', 'Region'),
    new Sprite('Freljord', 0, 'Freljord', 'img/sprites/18.png', 'Region'),
    new Sprite('Ionia', 14, 'Ionia', 'img/sprites/11.png', 'Region'),
    new Sprite('Noxus', 9, 'Noxus', 'img/sprites/1.png', 'Region'),
    new Sprite('Piltover', 5, 'PiltoverZaun', 'img/sprites/19.png', 'Region'),
    new Sprite('Shadow isles', 1, 'ShadowIsles', 'img/sprites/12.png', 'Region'),
    new Sprite('All regions', 13, 'AllFactions', 'img/sprites/17.png', 'Region'),
    new Sprite('Targon', 15, 'Targon', 'img/sprites/6.png', 'Region'),
    // new Sprite('Shurima', 7, '', 'img/sprites/7.png', 'Region'),
    // new Sprite('Void', 2, '', 'img/sprites/2.png', 'Region'),
    // new Sprite('Zaun', 20, '', 'img/sprites/20.png','Region'),
    // new Sprite('Bandle city', 10, '', 'img/sprites/10.png', 'Region'),
    new Sprite('Level up: empty', 10, 'ChampLevelUpIcon1', 'img/sprites/13.png', 'Levelup'),
    new Sprite('Level up: half', 6, 'ChampLevelUpIcon2', 'img/sprites/8.png', 'Levelup'),
    new Sprite('Level up: full', 2, 'ChampLevelUpIcon3', 'img/sprites/3.png', 'Levelup'),
    new Sprite('Common wildcard', 18, 'common', 'img/sprites/9.png', 'Wildcard'),
    new Sprite('Rare wildcard', 19, 'rare', 'img/sprites/4.png', 'Wildcard'),
    new Sprite('Epic wildcard', 20, 'epic', 'img/sprites/15.png', 'Wildcard'),
    new Sprite('Champion wildcard', 12, 'champion', 'img/sprites/16.png', 'Wildcard'),
    new Sprite('Shards', 17, 'currency_shards', 'img/sprites/14.png', 'Currency'),
    new Sprite('Coin', 3, 'currency_bp', 'img/sprites/24.png', 'Currency'),
    ...
    new Sprite('Burst', 16, 'Burst', 'img/sprites/21.png', 'Keyword'),
    ...
    new Sprite('Fast', 11, 'Fast', 'img/sprites/22.png', 'Keyword'),
    ...
    new Sprite('Slow', 7, 'Slow', 'img/sprites/23.png', 'Keyword'),
