...
var sprites = [
    ...
    new Sprite('Ionia', 13, 'Ionia', 'img/sprites/11.png', 'Region'),
    ...
    new Sprite('All regions', 12, 'AllFactions', 'img/sprites/17.png', 'Region'),
    new Sprite('Targon', '', 'Targon', 'img/sprites/6.png', 'Region'),
    ...
    new Sprite('Level up: empty', 14, 'ChampLevelUpIcon1', 'img/sprites/13.png', 'Levelup'),
    new Sprite('Level up: half', 10, 'ChampLevelUpIcon2', 'img/sprites/8.png', 'Levelup'),
    new Sprite('Level up: full', 6, 'ChampLevelUpIcon3', 'img/sprites/3.png', 'Levelup'),
    new Sprite('Common wildcard', 16, 'common', 'img/sprites/9.png', 'Wildcard'),
    new Sprite('Rare wildcard', 17, 'rare', 'img/sprites/4.png', 'Wildcard'),
    new Sprite('Epic wildcard', 18, 'epic', 'img/sprites/15.png', 'Wildcard'),
    new Sprite('Champion wildcard', 19, 'champion', 'img/sprites/16.png', 'Wildcard'),
    new Sprite('Shards', 3, 'currency_shards', 'img/sprites/14.png', 'Currency'),
    new Sprite('Coin', 7, 'currency_bp', 'img/sprites/24.png', 'Currency'),
    ...
    new Sprite('Burst', 2, 'Burst', 'img/sprites/21.png', 'Keyword'),
    ...
    new Sprite('Fast', 15, 'Fast', 'img/sprites/22.png', 'Keyword'),
    ...
    new Sprite('Slow', 11, 'Slow', 'img/sprites/23.png', 'Keyword'),
